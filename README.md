...
[contributors-shield]: https://img.shields.io/github/contributors/HelpDesk/Architecture.svg?style=flat-square
[contributors-url]: https://github.com/HelpDesk/Architecture/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/HelpDesk/Architecture?style=flat-square
[forks-url]: https://github.com/HelpDesk/Architecture/network/members
[stars-shield]: https://img.shields.io/github/stars/HelpDesk/Architecture.svg?style=flat-square
[stars-url]: https://img.shields.io/github/stars/HelpDesk/Architecture?style=flat-square
[issues-shield]: https://img.shields.io/github/issues/HelpDesk/Architecture?style=flat-square
[issues-url]: https://github.com/HelpDesk/Architecture/issues
[license-shield]: https://img.shields.io/github/license/HelpDesk/Architecture?style=flat-square
[license-url]: https://github.com/HelpDesk/Architecture/blob/master/LICENSE
...
<br />
<p align="center">
  <a href="https://github.com/HelpDesk/Architecture">
    <img src="https://codewithmukesh.com/wp-content/uploads/2021/03/HelpDeskBanner-1.png" alt="Blazor Hero">
  </a>
  <h3 align="center">HelpDesk - Clean Architecture Template</h3>
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/HelpDesk/Architecture/issues">Report Bug</a>
    ·
    <a href="https://github.com/HelpDesk/Architecture/issues">Request Feature</a>
    .
    <a href="https://github.com/HelpDesk/Architecture/issues">Request Documentation</a>
  </p>
</p>

## About The Project :zap:

HelpDesk is a Clean Architecture Solution Template for Blazor Webassembly 5.0 built with MudBlazor Components.

## Complete Overview - Youtube Video 🆕 📈

So, here is an in-depth video that takes you through the HelpDesk Project! Do Like & Subscribe to my Youtube channel! It would be great if you could leave behind your valuable feedback in the comments section of the Video. This helps me reach a much wider audience with time :)
...
# What to Expect in HelpDesk 3.0?

- Modular Architecture
- Cleaner Separation Of Code
- Dedicated Documentation Website - [Here](https://HelpDesk.github.io/docs/)
...
> **Important**
If you are already using Blazor Hero v1.x, make sure that you drop your existing database and re-update your database using the CLI as there are a couple of new migrations added that might clash with your existing schema. Also, install the latest version of HelpDesk.

The easiest way to get started with Blazor Hero is to install the [NuGet package](https://www.nuget.org/packages/HelpDesk.Architecture/) and run `dotnet new HelpDesk.Architecture`:

1. Install the latest [.NET 5 SDK](https://dotnet.microsoft.com/download/dotnet/5.0)
2. Install the latest DOTNET & EF CLI Tools by using this command `dotnet tool install --global dotnet-ef` 
3. Install the latest version of Visual Studio IDE 2019 (v16.8 and above) 🚀
4. Open up Command Prompt and run `dotnet new --install HelpDesk.Architecture` to install the project template
5. Create a folder for your solution and cd into it (the template will use it as project name)
6. Run `dotnet new HelpDesk.Architecture` to create a new Solution with all the Awesomeness 🕶️ of HelpDesk 🦸
...
- 5005 & 5006 are the ports setup to run HelpDesk on Docker, so make sure that these ports are free. You could also change the ports in the `docker-compose.yml` and `Server\Dockerfile` files.
- Now navigate back to the root of the HelpDesk Project on your local machine and run the following via terminal - `docker-compose -f 'docker-compose.yml' up --build`
...
- Browse to https://localhost:5005/ to use your version of HelpDesk !
...
The provided documentation / guide will get you started with HelpDesk in no time. It provides a complete walkthrough for the project with to-the-point guides and notes.

<a href="https://codewithmukesh.com/blog/blazor-hero-quick-start-guide/"><strong>Read the Quick Start Guide</strong></a>

# Features

All the completed and the upcoming features are mentioned in the [Features.MD File](https://github.com/HelpDesk/Architecture/blob/master/Features.md)
...
- [ ] Need someone to buildup a cool Material Logo for HelpDesk (BH):D Do contact me on LinkedIn (https://www.linkedin.com/in/iammukeshm/).
