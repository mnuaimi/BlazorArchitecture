...
using HelpDesk.Architecture.Application.Specifications.ExtendedAttribute;
...
namespace HelpDesk.Architecture.Application.Features.ExtendedAttributes.Queries.Export
{
